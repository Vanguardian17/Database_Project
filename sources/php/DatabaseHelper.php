...
class DatabaseHelper
{
    ...
    const username = 'a11825950'; // use a + your matriculation number
    ...
    public function insertIntoItem($Name, $Description, $Price, $Seller_Name)
    {
	$sql = "INSERT INTO Item(Name, Description, Price, Seller_Name) VALUES ('{$Name}', '{$Description}', '{$Price}', '{$Seller_Name}')";
    ...
    public function deleteItem($item_id)
    {
        ...
        // The SQL string
        $sql = 'BEGIN P_DELETE_ITEM(:item_id, :errorcode); END;';
        $statement = @oci_parse($this->conn, $sql);

        //  Bind the parameters
        @oci_bind_by_name($statement, ':item_id', $item_id);
	 ...
	 public function updateItem($Price, $ItemId)
    {
        $errorcode = 0;
